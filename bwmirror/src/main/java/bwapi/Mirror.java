...
public class Mirror {
    ...
    private static boolean extractAndLoadNativeLibraries(File bwapidata) {
        try {
            ...
            extractResourceFile("libgmp-10.dll", ai.getPath() + File.separator + "libgmp-10.dll");;

            System.out.println(LOG_TAG + "Loading libgmp-10.dll");
            System.load(ai.getAbsolutePath() + File.separator + "libgmp-10.dll");

            System.out.println(LOG_TAG + "Extracting libmpfr-4.dll");
            extractResourceFile("libmpfr-4.dll", ai.getPath() + File.separator + "libmpfr-4.dll");;

            System.out.println(LOG_TAG + "Loading libmpfr-4.dll");
            System.load(ai.getAbsolutePath() + File.separator + "libmpfr-4.dll");
            
            System.out.println(LOG_TAG + "Extracting bwapi_bridge.dll");
            extractResourceFile("bwapi_bridge.dll", ai.getPath() + File.separator + "bwapi_bridge.dll");

            System.out.println(LOG_TAG + "Loading bwapi_bridge.dll");
            System.load(ai.getAbsolutePath() + File.separator + "bwapi_bridge.dll");
